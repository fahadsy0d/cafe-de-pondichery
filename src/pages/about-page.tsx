      ...
      <section className="site-panel">
        <div className="page-shell grid gap-4 px-5 py-8 sm:px-8 lg:grid-cols-3 lg:px-10">
          {storyMoments.map((moment) => (
            <article className="rounded-[1.5rem] border border-border bg-white/55 p-5 sm:rounded-[2rem] sm:p-6" key={moment.title}>
              <h2 className="text-[2rem] leading-none tracking-[-0.04em] text-foreground sm:text-3xl">{moment.title}</h2>
